...
from api.handlers import SongHandler, QueueHandler, UserHandler, ArtistHandler
...
queue_handler = Resource(QueueHandler, **ad)
...
urlpatterns = patterns('',
   ...
   url(r'^^doc/$', documentation_view, name="api_docs"),
)

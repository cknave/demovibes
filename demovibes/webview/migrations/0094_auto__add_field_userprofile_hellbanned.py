...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Userprofile.hellbanned'
        db.add_column('webview_userprofile', 'hellbanned', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Userprofile.hellbanned'
        db.delete_column('webview_userprofile', 'hellbanned')
    ...
    models = {
        ...
        'webview.compilation': {
            ...
            'songs': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['webview.Song']", 'null': 'True', 'through': "orm['webview.CompilationSongList']", 'blank': 'True'}),
            'startswith': ('django.db.models.fields.CharField', [], {'max_length': '1', 'db_index': 'True'}),
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 18, 21, 44, 32, 410696)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.userprofile': {
            ...
            'hellbanned': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'hol_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 18, 21, 44, 32, 396029)'}),

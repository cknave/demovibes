...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Userprofile.last_ip'
        db.add_column('webview_userprofile', 'last_ip', self.gf('django.db.models.fields.IPAddressField')(default='', max_length=15, blank=True), keep_default=False)

        # Changing field 'OnelinerMuted.reason'
        db.alter_column('webview_onelinermuted', 'reason', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Deleting field 'Userprofile.last_ip'
        db.delete_column('webview_userprofile', 'last_ip')

        # Changing field 'OnelinerMuted.reason'
        db.alter_column('webview_onelinermuted', 'reason', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        'webview.compilation': {
            ...
            'songs': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['webview.Song']", 'null': 'True', 'symmetrical': 'False', 'through': "orm['webview.CompilationSongList']", 'blank': 'True'}),
            'startswith': ('django.db.models.fields.CharField', [], {'max_length': '1', 'db_index': 'True'}),
        ...
        'webview.compilationsonglist': {
            'Meta': {'ordering': "['index']", 'object_name': 'CompilationSongList'},
            'compilation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['webview.Compilation']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 27, 16, 52, 57, 951824)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.onelinermuted': {
            'Meta': {'ordering': "['-id']", 'object_name': 'OnelinerMuted'},
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'added_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mutes'", 'to': "orm['auth.User']"}),
            'details': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'muted_to': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            'reason': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        ...
        'webview.screenshot': {
            'Meta': {'ordering': "['name']", 'object_name': 'Screenshot'},
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '1', 'db_index': 'True'})
        },
        'webview.screenshotobjectlink': {
            'Meta': {'unique_together': "(['content_type', 'object_id', 'image'],)", 'object_name': 'ScreenshotObjectLink'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['webview.Screenshot']"}),
        ...
        'webview.song': {
            ...
            'license': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['webview.SongLicense']", 'null': 'True', 'blank': 'True'}),
            ...
            'playback_bass_inter': ('django.db.models.fields.CharField', [], {'max_length': '6', 'blank': 'True'}),
            'playback_bass_mix': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
            'playback_bass_mode': ('django.db.models.fields.CharField', [], {'max_length': '4', 'blank': 'True'}),
            'playback_bass_ramp': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'playback_fadeout': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'pouetgroup': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'pouetlink': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
        ...
        'webview.songlicense': {
            'Meta': {'object_name': 'SongLicense'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'downloadable': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'icon': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'unique': 'True', 'blank': 'True'})
        },
        ...
        'webview.theme': {
            'Meta': {'ordering': "['-default', 'title']", 'object_name': 'Theme'},
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 27, 16, 52, 57, 940220)'}),
            ...
            'show_screenshots': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),

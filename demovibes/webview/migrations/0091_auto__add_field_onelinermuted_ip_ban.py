...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OnelinerMuted.ip_ban'
        db.add_column('webview_onelinermuted', 'ip_ban', self.gf('django.db.models.fields.IPAddressField')(default='', max_length=15, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OnelinerMuted.ip_ban'
        db.delete_column('webview_onelinermuted', 'ip_ban')
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 27, 17, 4, 45, 396744)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.onelinermuted': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip_ban': ('django.db.models.fields.IPAddressField', [], {'max_length': '15', 'blank': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 27, 17, 4, 45, 384339)'}),
